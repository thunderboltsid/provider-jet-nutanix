...
func main() {
	var (
		app              = kingpin.New(filepath.Base(os.Args[0]), "Terraform based Crossplane provider for Nutanix").DefaultEnvars()
	...
	log := logging.NewLogrLogger(zl.WithName("provider-jet-nutanix"))
	if *debug {
	...
	mgr, err := ctrl.NewManager(cfg, ctrl.Options{
		...
		LeaderElectionID:           "crossplane-leader-election-provider-jet-nutanix",
	...
	kingpin.FatalIfError(controller.Setup(mgr, o), "Cannot setup Nutanix controllers")
