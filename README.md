# Terrajet Nutanix Provider

`provider-jet-nutanix` is a [Crossplane](https://crossplane.io/) provider that
...
provider-jet-nutanix is run according to the same
...
provider-jet-nutanix adheres to the same [Code of
Conduct](https://github.com/crossplane/crossplane/blob/master/CODE_OF_CONDUCT.md)
as the core Crossplane project.

## Licensing

provider-jet-nutanix is under the Apache 2.0 license.
